      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Real Estate Market
            <span className="text-primary block">Insights & Analytics</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            <div className="bg-card p-6 rounded-lg border border-border">
              ...
              <div className="text-2xl font-bold text-foreground mb-2">$421,700</div>
            ...
            <div className="bg-card p-6 rounded-lg border border-border">
              ...
              <div className="text-2xl font-bold text-foreground mb-2">28 days</div>
              <div className="text-red-600 text-sm">+2 days from last month</div>
            </div>
            ...
            <div className="bg-card p-6 rounded-lg border border-border">
              ...
              <div className="text-2xl font-bold text-foreground mb-2">3.1 months</div>
              <div className="text-yellow-600 text-sm">Balanced market</div>
            </div>
            ...
            <div className="bg-card p-6 rounded-lg border border-border">
              ...
              <div className="text-2xl font-bold text-foreground mb-2">6.82%</div>
              <div className="text-green-600 text-sm">-0.15% from last week</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card p-6 rounded-lg border border-border flex flex-col md:flex-row items-start md:items-center justify-between">
              <div className="flex-1">
                <h3 className="text-xl font-semibold mb-2">AI in Real Estate: 2025 Adoption Report</h3>
                <p className="text-muted-foreground mb-2">How artificial intelligence is transforming property valuation, risk assessment, and market analysis across the industry.</p>
                <span className="text-sm text-muted-foreground">Published: June 15, 2025</span>
              </div>
            ...
            <div className="bg-card p-6 rounded-lg border border-border flex flex-col md:flex-row items-start md:items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-muted-foreground mb-2">Comprehensive analysis of how climate change is affecting property values and insurance costs nationwide.</p>
                <span className="text-sm text-muted-foreground">Published: June 8, 2025</span>
              </div>
              <div className="mt-4 md:mt-0 md:ml-6">
                <button className="bg-primary text-primary-foreground px-6 py-2 rounded-md hover:bg-primary/90 font-medium">
                  Download PDF
            ...
            <div className="bg-card p-6 rounded-lg border border-border flex flex-col md:flex-row items-start md:items-center justify-between">
              <div className="flex-1">
                ...
                <p className="text-muted-foreground mb-2">Analysis of continued remote work trends and their lasting effects on suburban vs. urban property demand.</p>
                <span className="text-sm text-muted-foreground">Published: May 25, 2025</span>
              </div>
              <div className="mt-4 md:mt-0 md:ml-6">
                <button className="bg-primary text-primary-foreground px-6 py-2 rounded-md hover:bg-primary/90 font-medium">
                  Download PDF
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
            <input 
              ...
              className="flex-1 px-4 py-3 bg-card border border-border rounded-md text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
            />
            <button className="bg-primary text-primary-foreground px-6 py-3 rounded-md hover:bg-primary/90 font-medium">
              Subscribe
            </button>
          </div>
        </div>
