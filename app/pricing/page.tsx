          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-card p-8 rounded-lg border border-border">
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-6">Perfect for individual agents and small teams</p>
              </div>
              ...
              <button className="w-full bg-primary text-primary-foreground py-3 rounded-md hover:bg-primary/90 font-medium">
                Start Free Trial
              </button>
            </div>
            ...
            <div className="bg-card p-8 rounded-lg border-2 border-primary relative">
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground mb-6">Ideal for real estate teams and small brokerages</p>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-card p-8 rounded-lg border border-border">
              ...
              <button className="w-full border border-border text-foreground py-3 rounded-md hover:bg-secondary font-medium">
                Contact Sales
              </button>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card p-6 rounded-lg">
              ...
              <p className="text-muted-foreground">You&apos;ll receive notifications as you approach your limit. You can upgrade your plan or purchase additional reports as needed.</p>
            </div>
          </div>
        </div>
      </section>
