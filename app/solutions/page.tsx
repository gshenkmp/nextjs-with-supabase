      ...
      <section className="py-16 bg-secondary">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/dashboard" className="bg-primary text-primary-foreground px-8 py-3 rounded-md font-semibold hover:bg-primary/90 text-lg">
              Start Free Trial
            </Link>
            <Link href="/pricing" className="border border-border text-foreground px-8 py-3 rounded-md font-semibold hover:bg-card text-lg">
              View Pricing
            </Link>
          </div>
        </div>
