            ...
            <div className="bg-gray-800 p-8 rounded-lg border border-gray-700">
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  ...
                  <div className="text-gray-400">Professionals Served</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-blue-400 mb-2">500,000+</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-blue-400 mb-3">CEO & Co-Founder</p>
            ...
            <div className="text-center">
              ...
              <p className="text-blue-400 mb-3">VP of Product</p>
              <p className="text-gray-400 text-sm">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1 border-l border-gray-700 pl-8 pb-8">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div>
                    <h3 className="text-lg font-semibold mb-1">Founded</h3>
                    <p className="text-gray-400">Company founded with vision to democratize property intelligence</p>
                  </div>
                  <span className="text-blue-400 font-medium mt-2 md:mt-0">2022</span>
                </div>
              </div>
            </div>
              ...
              <div className="flex-1 border-l border-gray-700 pl-8 pb-8">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div>
                    ...
                    <p className="text-gray-400">Raised $15M to accelerate product development and market expansion</p>
                  </div>
                  <span className="text-blue-400 font-medium mt-2 md:mt-0">2023</span>
                </div>
              </div>
            </div>
              ...
              <div className="flex-1 border-l border-gray-700 pl-8 pb-8">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div>
                    ...
                    <p className="text-gray-400">Launched AI-powered property intelligence platform to market</p>
                  </div>
                  <span className="text-blue-400 font-medium mt-2 md:mt-0">2024</span>
                </div>
              </div>
            </div>
              ...
              <div className="flex-1 pl-8">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                  <div>
                    ...
                    <p className="text-gray-400">Reached milestone of serving over 10,000 real estate professionals</p>
                  </div>
                  <span className="text-blue-400 font-medium mt-2 md:mt-0">2025</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-800">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/dashboard" className="bg-blue-600 text-white px-8 py-3 rounded-md font-semibold hover:bg-blue-700">
              Get Started Today
            </Link>
            <button className="border border-gray-600 text-gray-300 px-8 py-3 rounded-md font-semibold hover:bg-gray-700">
              Contact Us
            </button>
          </div>
        </div>
